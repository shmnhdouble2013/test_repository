	...
	S.augment(buttonBarItem,{
		...
		_getItemTemplate : function(){
			var _self = this,
				...
				temp = ['<div data-id="',_self.id,'" class="', CLS_BTN_CONTAINER, ' ', clsDisable, ' ', _self.containerCss,' "><button class="button button-small ',iconCss,'" autocomplete="off" hidefocus="true" ', disabledText, ' type="button">',iconTpl, _self.text, '</button></div>'].join('');
			return temp;
		},
