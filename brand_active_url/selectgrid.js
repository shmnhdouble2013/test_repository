...
*/	
KISSY.add('mui/selectGrid', function(S, O, Pagination, XTemplate, Validation, Grid) {
	var DOM = S.DOM,
		Ajax = S.IO,
		Event = S.Event,
		S_Date = S.Date;
...
}, {'requires':['mui/overlay','mui/overlay/overlay.css', 'gallery/pagination/2.0/index', 'xtemplate', 'Validation', 'mui/grid', 'sizzle']});