...
KISSY.add('gallery/pagination/2.0/index', function(S, Base, EVENT, NODE, DOM){
	...
	S.extend(Pagination, S.Base, {
		...
		_resetPagination: function() {
			...
			// currPage前的页码展示
			paginationInner += currPage === 1 ? '<span class="pagination-start"><span class="iconfont">&#xe646;</span></span>' : '<a class="pagination-prev"><span class="iconfont">&#xe646;</span></a>';
			...
			paginationInner += currPage === totalPage ? '<span class="pagination-end"><span class="iconfont">&#xe64c;</span></span>' : '<a class="pagination-next"><span class="iconfont">&#xe64c;<span></a>';
