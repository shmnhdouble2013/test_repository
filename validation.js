...
gallery/validation/1.1/utils
gallery/validation/1.1/define
gallery/validation/1.1/rule/base
gallery/validation/1.1/rule/normal
gallery/validation/1.1/rule
gallery/validation/1.1/rule/remote
gallery/validation/1.1/warn/baseclass
gallery/validation/1.1/warn/base
gallery/validation/1.1/warn/alert
gallery/validation/1.1/warn/static
gallery/validation/1.1/warn/float
gallery/validation/1.1/warn
gallery/validation/1.1/field
gallery/validation/1.1/base
gallery/validation/1.1/index
...
KISSY.add('gallery/validation/1.1/define',function(){
 ...
 * @author 常胤 <lzlu.com>
 */
KISSY.add('gallery/validation/1.1/rule/base',function(S, DOM, Event, Util) {
 ...
 * @author 常胤 <lzlu.com>
 */
KISSY.add('gallery/validation/1.1/rule/normal',function(S, DOM, Event, Util, Rule) {
...
KISSY.add('gallery/validation/1.1/rule',function(S, Util, Rule) {
 ...
 * @author 常胤 <lzlu.com>
 */
KISSY.add('gallery/validation/1.1/rule/remote',function(S, DOM, Event, Util) {
...
KISSY.add('gallery/validation/1.1/warn/baseclass',function(S, DOM, Event) {
 ...
 * @author 常胤 <lzlu.com>
 */
KISSY.add('gallery/validation/1.1/warn/base',function(S, DOM, Event, Util, BaseClass) {
 ...
 * @author 常胤 <lzlu.com>
 */
KISSY.add('gallery/validation/1.1/warn/static',function(S, Node, Util, Define) {
    var symbol = Define.Const.enumvalidsign,
        $ = Node.all;
 ...
 * @author 常胤 <lzlu.com>
 */
KISSY.add('gallery/validation/1.1/warn/float',function (S, DOM, Event, Util, Define) {
    var symbol = Define.Const.enumvalidsign;
...
KISSY.add('gallery/validation/1.1/warn',function(S, Util, Warn, BaseClass, Alert, Static, Float) {
 ...
 * @author 常胤 <lzlu.com>
 */
KISSY.add('gallery/validation/1.1/field',function (S, DOM, Event, Util, Define, Rule, Remote, Warn) {
    var symbol = Define.Const.enumvalidsign,
        doc = document;
...
KISSY.add('gallery/validation/1.1/base',function(S, DOM, Event, Util, Define, Field, Warn, Rule) {
    ...
    S.augment(Validation, S.EventTarget, {
        ...
        _initfields: function() {
            ...
            S.each(self.form.elements, function(el) {
                ...
                if (attr)self.add(el, Util.toJSON(attr.replace(/'/g, '"'))); // add 元素添加 校验实例
            });
        },
        ...
        add: function(field, config) {
            ...
            var el = DOM.get(field) || DOM.get("#" + field), 
				id = DOM.attr(el, "id");
 ...
 * @date 2011.06.21
 */
KISSY.add('gallery/validation/1.1/index',function (S, Validation) {
        return Validation;
}, {
    requires: ["./base", "./assets/base.css"]
});
